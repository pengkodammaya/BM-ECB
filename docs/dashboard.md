...
**Last updated:** 2026-08-03 | **Latest actual:** Q1 2026 | **Nowcasting:** Q3 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+4.6%` | -0.8pp | Dynamic Factor Model |
...
| **Investment (I)** | +7.8% | +7.3% | 0.5pp |
| **Government (G)** | +5.9% | +4.1% | 1.8pp |

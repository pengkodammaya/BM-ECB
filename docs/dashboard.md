...
**Last updated:** 2026-06-27 | **Latest actual:** Q1 2026 | **Nowcasting:** Q2 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+12.0%` | 6.6pp | Dynamic Factor Model |
...
| Manufacturing | `+5.9%` | `+4.4%` | `1.5pp` |
| Construction | `+7.7%` | `-2.6%` | `10.3pp` |

...
**Last updated:** 2026-06-19 | **Latest actual:** Q1 2026 | **Nowcasting:** Q2 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+11.8%` | 6.4pp | Dynamic Factor Model |
| **BVAR** | `+5.1%` | -0.3pp | Bayesian VAR |
| **AR(1)** | `+5.4%` | — | Persistence (baseline) |
| **Ensemble** | `+8.5%` | 3.1pp | Median of DFM + BVAR |

...
**Last updated:** 2026-09-25 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+2.9%` | -3.1pp | Dynamic Factor Model |
| **BVAR** | `+4.9%` | -1.1pp | Bayesian VAR |
| **AR(1)** | `+6.0%` | — | Persistence (baseline) |
| **Ensemble** | `+4.3%` | -1.7pp | Median of DFM + BVAR |
...
| 2026-09-25 | 2026-Q3 | +2.9% | +4.9% | — | +4.3% | — |

...
**Last updated:** 2026-08-05 | **Latest actual:** Q1 2026 | **Nowcasting:** Q3 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+9.5%` | 4.1pp | Dynamic Factor Model |
| **BVAR** | `+4.5%` | -1.0pp | Bayesian VAR |
| **AR(1)** | `+5.4%` | — | Persistence (baseline) |
| **Ensemble** | `+4.5%` | -1.0pp | Median of DFM + BVAR |

...
**Last updated:** 2026-08-07 | **Latest actual:** Q1 2026 | **Nowcasting:** Q3 2026
...
|-------|:-------:|:--------:|-------------|
| **DFM** | `+4.0%` | -1.4pp | Dynamic Factor Model |
| **BVAR** | `+4.6%` | -0.8pp | Bayesian VAR |
| **AR(1)** | `+5.4%` | — | Persistence (baseline) |
| **Ensemble** | `+4.2%` | -1.2pp | Median of DFM + BVAR |
...
| **Exports (X)** | +5.0% | +5.2% | 0.2pp |
| **Imports (M)** | +7.1% | +4.6% | 2.5pp |

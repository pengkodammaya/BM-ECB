...
**Updated:** 2026-08-03 | **Latest actual:** Q1 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.8% | +5.5% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +7.8% | +4.9% | pending | pending |
| **Government Consumption** (G) | +5.9% | +4.9% | pending | pending |
| **Exports** (X) | +5.0% | -1.2% | pending | pending |
| **Imports** (M) | +7.2% | +4.1% | pending | pending |

...
**Updated:** 2026-09-08 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.1% | +8.2% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +6.3% | +6.5% | pending | pending |
| **Government Consumption** (G) | +4.1% | +4.4% | pending | pending |
| **Exports** (X) | +3.7% | +8.2% | pending | pending |
| **Imports** (M) | +4.8% | +4.3% | pending | pending |

...
**Updated:** 2026-07-23 | **Latest actual:** Q1 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.8% | +6.5% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +7.5% | +3.3% | pending | pending |
| **Government Consumption** (G) | +5.9% | +4.9% | pending | pending |
| **Exports** (X) | +5.0% | -1.9% | pending | pending |
| **Imports** (M) | +7.4% | +4.0% | pending | pending |

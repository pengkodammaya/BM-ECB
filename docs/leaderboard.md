...
**Updated:** 2026-06-14 | **Latest actual:** Q1 2026 | **Nowcasting:** Q2 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +5.6% | +14.1% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +7.6% | +0.4% | pending | pending |
| **Government Consumption** (G) | +5.8% | +3.6% | pending | pending |
| **Exports** (X) | +6.1% | -3.4% | pending | pending |

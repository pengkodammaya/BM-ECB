...
**Updated:** 2026-09-02 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.0% | +9.8% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +6.3% | +6.9% | pending | pending |
| **Government Consumption** (G) | +4.1% | +4.5% | pending | pending |
| **Exports** (X) | +3.6% | +10.2% | pending | pending |
| **Imports** (M) | +4.6% | +4.5% | pending | pending |

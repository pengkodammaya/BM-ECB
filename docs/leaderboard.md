...
**Updated:** 2026-08-17 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.0% | +7.1% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +6.5% | +5.8% | pending | pending |
| **Government Consumption** (G) | +4.2% | +4.8% | pending | pending |
| **Exports** (X) | +4.0% | -0.5% | pending | pending |
| **Imports** (M) | +4.3% | +4.9% | pending | pending |

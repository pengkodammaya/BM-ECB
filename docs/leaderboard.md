...
| **Gross Fixed Capital Formation** (I) | +7.6% | -0.3% | pending | pending |
| **Government Consumption** (G) | +5.8% | +3.5% | pending | pending |
| **Exports** (X) | +6.2% | -5.9% | pending | pending |
| **Imports** (M) | +7.5% | +4.1% | pending | pending |
...
| 2026-06-19 | 2026-Q2 | +2.6% | +5.1% | — | +3.9% |

...
**Updated:** 2026-09-06 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.1% | +8.6% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +6.3% | +6.6% | pending | pending |
| **Government Consumption** (G) | +4.1% | +4.5% | pending | pending |
| **Exports** (X) | +3.7% | +8.0% | pending | pending |
| **Imports** (M) | +4.8% | +4.2% | pending | pending |

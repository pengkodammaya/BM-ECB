...
**Updated:** 2026-08-29 | **Latest actual:** Q2 2026 | **Nowcasting:** Q3 2026
...
|-----------|------|-----|-------------------|-------|
| **Private Consumption** (C) | +4.1% | +6.7% | pending | pending |
| **Gross Fixed Capital Formation** (I) | +6.4% | +5.9% | pending | pending |
| **Government Consumption** (G) | +4.2% | +4.7% | pending | pending |
| **Exports** (X) | +4.0% | +0.7% | pending | pending |
| **Imports** (M) | +4.5% | +4.6% | pending | pending |
